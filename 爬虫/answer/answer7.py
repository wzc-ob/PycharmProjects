...
def login(username, password):
    ...
    resp = session.post(url="https://passport.baidu.com/v2/api/?login", data=postdata, headers=headers)
...
if __name__ == "__main__":
    ...
    home_page = session.get("http://pan.baidu.com/disk/home", headers=headers).content.decode("utf-8", "ignore")
    print(home_page)
